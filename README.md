...
--------------------------------|_|------------------------
-Coding for you since 2010. All rights reserved © 2016 year
-----------------------------------------------------------
```
...
<p align="center" >
<img src="https://snag.gy/yc6GEO.jpg" width="500" height="356"/>
</p>
...
* **Автоматическая авторизация в клиенте игры** по созраненным пользовательским данным:
...
```Ограничение [пропускной способности](https://ru.wikipedia.org/wiki/Пропускная_способность)```
...
---
##Отзывы
Я бы с удовольствием получал отзывы о недоработках, предложениях и Ваши наработки. Создавайте Github issues, или пишите личным сообщением (на сайте ```wowjp``` или по предоставленным контактным данным).
